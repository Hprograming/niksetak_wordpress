...
if ( ! function_exists( 'us_get_current_id' ) ) {
	...
	function us_get_current_id() {
		...
		// Grid item ID
		global $us_grid_listing_start, $us_grid_object_type, $us_grid_term;
		if ( $us_grid_listing_start === TRUE ) {

			// Grid term ID
			if ( $us_grid_object_type == 'term' AND $us_grid_term instanceof WP_Term ) {
...
if ( ! function_exists( 'us_get_current_meta_type' ) ) {
	...
	function us_get_current_meta_type() {
		...
		global $us_grid_listing_start, $us_grid_object_type;
		if ( $us_grid_listing_start === TRUE ) {
			return $us_grid_object_type;
		}
...
if ( ! function_exists( 'us_conditions_are_met' ) ) {
	...
	function us_conditions_are_met( $conditions, $conditions_operator ) {
		...
		global $us_grid_listing_start, $us_grid_term;
		if ( $us_grid_listing_start === TRUE ) {
